...
const Subscribe = () => {
  ...
  return (
    <section className="mt-40 md:mt-56 mb-24 items-center gap-4 md:grid md:grid-cols-2 px-1">
      ...
      <div className="fan-cards-small mt-12">
        <div className="image1 relative flex justify-center text-5xl md:hidden perspective-origin-top-leftop perspective-200">
          <Image
            className="one relative left-[70px] aspect-square w-[50%] rounded-xl object-cover object-top opacity-[60%] md:-ml-8 transform rotate-y-30 "
          ...
          />
          <Image
            className="three relative left-[-70px]  aspect-square w-[50%] rounded-xl object-cover object-top opacity-[60%] md:-ml-8 transform -rotate-y-30 "
