    ...
    <section className="mb-24 py-6 md:grid md:grid-cols-2">
      <div className=" mb-6 space-y-8 text-center text-white md:max-w-[70ch] md:text-start">
        ...
        <div className="flex justify-center gap-4 font-bold md:justify-start">
          <button className=" rounded-lg bg-primary px-5 py-2 text-gray-800 hover:bg-blue-950 hover:text-primary hover:outline-dotted hover:outline-2 hover:outline-primary md:px-11 md:py-3">
            Explore Now
          </button>
          <button className="">
